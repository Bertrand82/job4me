...
export const reponseAnalyseOffreEmploi = {
  "type": "object",
  "properties": {
    "offre.titre": { "type": "string" ,"description":"récupérer le titre de l’offre d'emploi ou si il n'y en a pas, générer un titre résumant les compétences demandées" },
...
export const reponseAnalyseCV = {
  "type": "object",
  "properties": {
    "cv.titre": { "type": "string", "description": "récupérer le titre du cv ou si il n'y en a pas, générer un titre résumant le cv" },
    ...
    "cv.personne": { "type": "string", "description": "renseigne le nom de la personne identifiée dans l’offre" },
    "cv.email": { "type": "string", "description": "renseigne l'email de la personne identifiée dans l’offre" },
    "cv.nationalité": { "type": "string", "description": "renseigne la nationalité du candidat" },
    "cv.adresse": { "type": "string", "description": "renseigne le pays du poste identifié dans l’offre" },
    "cv.freelance": { "type": "boolean", "description": "Dans l'offre d'emploi,précise si le poste est en freelance ou non" },
    "cv.langues": {
      "type": "array",
      "items": { "type": "string", "enum": ["fr", "en", "es"] },
      "description": "renseigne les langues du cv"
    },
    "cv.langue": { "type": "string", "enum": ["fr", "en", "es"], "description": "renseigne la langue du cv" },
