...
export const functionBgStripeGetClient = express();
...
functionBgStripeGetClient.use(cors({origin: allowedOrigins}));

// eslint-disable-next-line max-len
functionBgStripeGetClient.get("/", async (req: Request, res: Response) => {
